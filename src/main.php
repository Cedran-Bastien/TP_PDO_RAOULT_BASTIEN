...
if(isset($_GET['libelle']) and isset($_GET['DD']) and isset($_GET['DF'])){
    ...
    echo "Les véhicules disponibles({$_GET['libelle']}) de {$_GET['DD']} à {$_GET['DF']} sont : " . "<br>";
...
if(isset($_POST['immat']) and isset($_POST['DD2']) and isset($_POST['DF2'])){
    ...
    echo "Les lignes modifiées ({$_POST['immat']} entre {$_POST['DD2']} et {$_POST['DF2']} ) sont : " . "<br><br>";
...
if(isset($_GET['nbjours']) and isset($_GET['modele'])){
    ...
    while($data = $resultat2->fetch()){
        echo "Le montant de la location du modele {$_GET['modele']} pendant {$_GET['nbjours']} sera de : " .  $data['tar'] . "€<br>";
    }
}
echo "</fieldset>";
echo "<br>";
...
if (isset($_GET['modele1']) and isset($_GET['modele2'])){
    ...
    echo "les client ayant louer une {$_GET['modele1']} et une {$_GET['modele2']} sont : </br>";
